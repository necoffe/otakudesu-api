...
// Helper function to fetch page with puppeteer (bypasses Cloudflare)
async function fetchPage(url, retries = 3) {
    ...
    for (let i = 0; i < retries; i++) {
        ...
        try {
            ...
            // Wait to resolve cloudflare if needed
            ...
            if (i === retries - 1) {
                return cheerio.load('<html><body></body></html>'); // Return empty instead of crashing
            }
